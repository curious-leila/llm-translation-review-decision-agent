# NODE-02 Post-Eval Control Classifier Prompt · v3

> prompt_id: node02_post_eval_control_v3
> status: DEVELOPMENT CANDIDATE — EVIDENCE NEED GATE V3
> source: Evidence Need Gate v3 — Option 2 Product Design Freeze
...
- `term_candidate` 必须非空，并精确指出待核实的 source term/span；
...
```json
{
  "terminology": {
    ...
    "term_candidate": "需要核实的具体源术语或 span",
    "evidence_need": "需要由明确 authority 验证的外部命名事实；不写正确答案",
